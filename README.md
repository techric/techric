...
> Building secure, automated, audit-ready cloud environments — IaC-first, least privilege by default.
...
- Hands-on AWS projects built to demo and tear down cleanly (no lingering costs)
- A recruiter-friendly README standard for cloud project documentation
